...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(PATCH, "/limit-change/**").hasAuthority(String.valueOf(Permissions.MANAGE_AGENTS))
                .antMatchers(PATCH, "/limit-reset/**").hasAuthority(String.valueOf(Permissions.MANAGE_AGENTS));
